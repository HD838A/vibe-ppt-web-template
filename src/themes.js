...
const shared = {
  ...
  '--theme-motion-enter-duration': '560ms',
  '--theme-motion-slide-duration': '320ms',
  '--theme-motion-stagger': '55ms',
  '--theme-motion-distance': '18px',
  '--theme-motion-hover-lift': '-4px',
  '--theme-motion-ambient-duration': '12s',
...
export const themes = {
  ...
  apple: {
    id: 'apple', name: '苹果风', vars: { ...shared,
      ...
      '--theme-motion-enter-duration': '700ms', '--theme-motion-slide-duration': '420ms', '--theme-motion-stagger': '70ms',
      '--theme-motion-distance': '24px', '--theme-motion-hover-lift': '-6px', '--theme-motion-ambient-duration': '16s',
  ...
  dopamine: {
    id: 'dopamine', name: '多巴胺', vars: { ...shared,
      ...
      '--theme-motion-enter-duration': '520ms', '--theme-motion-slide-duration': '360ms', '--theme-motion-stagger': '65ms',
      '--theme-motion-distance': '22px', '--theme-motion-hover-lift': '-8px', '--theme-motion-ambient-duration': '8s',
  ...
  cyberpunk: {
    id: 'cyberpunk', name: '赛博朋克', vars: { ...shared,
      ...
      '--theme-motion-enter-duration': '260ms', '--theme-motion-slide-duration': '180ms', '--theme-motion-stagger': '34ms',
      '--theme-motion-distance': '10px', '--theme-motion-hover-lift': '-2px', '--theme-motion-ambient-duration': '6s',
